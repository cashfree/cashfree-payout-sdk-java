...
import com.cashfree.model.CreateTransferRequestBeneficiaryDetailsBeneficiaryInstrumentDetails;
...
public class CreateTransferRequestBeneficiaryDetails {
  ...
  private CreateTransferRequestBeneficiaryDetailsBeneficiaryInstrumentDetails beneficiaryInstrumentDetails;
  ...
  public CreateTransferRequestBeneficiaryDetails() {
  }

  public CreateTransferRequestBeneficiaryDetails beneficiaryId(String beneficiaryId) {
  ...
  **/
  ...
  public CreateTransferRequestBeneficiaryDetails beneficiaryName(String beneficiaryName) {
  ...
  **/
  @javax.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "It is the name of the beneficiary. The maximum character limit is 100.  Only alphabets and whitespaces are allowed. It is required if beneficiary_id is not present.")
  ...
  public CreateTransferRequestBeneficiaryDetails beneficiaryInstrumentDetails(CreateTransferRequestBeneficiaryDetailsBeneficiaryInstrumentDetails beneficiaryInstrumentDetails) {
  ...
  **/
  ...
  public CreateTransferRequestBeneficiaryDetailsBeneficiaryInstrumentDetails getBeneficiaryInstrumentDetails() {
    return beneficiaryInstrumentDetails;
  }


  public void setBeneficiaryInstrumentDetails(CreateTransferRequestBeneficiaryDetailsBeneficiaryInstrumentDetails beneficiaryInstrumentDetails) {
    this.beneficiaryInstrumentDetails = beneficiaryInstrumentDetails;
  }


  public CreateTransferRequestBeneficiaryDetails beneficiaryContactDetails(CreateTransferRequestBeneficiaryDetailsBeneficiaryContactDetails beneficiaryContactDetails) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateTransferRequestBeneficiaryDetails createTransferRequestBeneficiaryDetails = (CreateTransferRequestBeneficiaryDetails) o;
    return Objects.equals(this.beneficiaryId, createTransferRequestBeneficiaryDetails.beneficiaryId) &&
        Objects.equals(this.beneficiaryName, createTransferRequestBeneficiaryDetails.beneficiaryName) &&
        Objects.equals(this.beneficiaryInstrumentDetails, createTransferRequestBeneficiaryDetails.beneficiaryInstrumentDetails) &&
        Objects.equals(this.beneficiaryContactDetails, createTransferRequestBeneficiaryDetails.beneficiaryContactDetails);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CreateTransferRequestBeneficiaryDetails
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("beneficiary_instrument_details") != null && !jsonObj.get("beneficiary_instrument_details").isJsonNull()) {
        CreateTransferRequestBeneficiaryDetailsBeneficiaryInstrumentDetails.validateJsonElement(jsonObj.get("beneficiary_instrument_details"));
      }
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateTransferRequestBeneficiaryDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateTransferRequestBeneficiaryDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateTransferRequestBeneficiaryDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateTransferRequestBeneficiaryDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateTransferRequestBeneficiaryDetails>() {
           @Override
           public void write(JsonWriter out, CreateTransferRequestBeneficiaryDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateTransferRequestBeneficiaryDetails read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CreateTransferRequestBeneficiaryDetails given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateTransferRequestBeneficiaryDetails
  * @throws IOException if the JSON string is invalid with respect to CreateTransferRequestBeneficiaryDetails
  */
  public static CreateTransferRequestBeneficiaryDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateTransferRequestBeneficiaryDetails.class);
  }

 /**
  * Convert an instance of CreateTransferRequestBeneficiaryDetails to an JSON string
  *
  * @return JSON string
  */
